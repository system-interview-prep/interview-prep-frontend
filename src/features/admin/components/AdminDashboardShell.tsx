    ...
    <div className="min-w-0 overflow-x-hidden bg-[#FEF9EE] font-body text-[#234196] selection:bg-[#FCB625]">
      ...
      <header className="sticky top-0 z-30 flex items-center justify-between border-b-2 border-[#234196] bg-white px-4 py-3 [&>div]:mb-0 md:hidden">
        ...
        <div className="flex items-center gap-2">
          <Link href="/admin/job-profiles/create" className="chunky-primary min-h-11 px-3 text-xs" aria-label={t("admin.sidebar.createProfile")}><Plus className="size-5" /></Link>
          <Link href="/admin/settings" className="grid h-11 w-11 place-items-center rounded-xl border-2 border-[#234196] bg-white" aria-label={t("common.settings")}><Settings className="size-5" /></Link>
        </div>
      </header>
